...
d+n+a.offset,a.offset,a.annotation?a.annotation:null)+(k&&a.targetSeq.charAt(n)!=res?' nm="true"':"")+">"+res+"</span>":(l+="<span "+ja(res.toUpperCase(),e+a.offset,a.offset,a.annotation?a.annotation:null)+(k&&a.targetSeq.charAt(n)!=res?' nm="true"':"")+">"+res+"</span>",e++);return l}function ja(c,a,e,d,f){c='s="'+a+'" r="'+c+'"';d&&(d.qmean&&null!=d.qmean[f?f:a-e]&&(c+=' q="'+d.qmean[f?f:a-e]+'" style="font-weight:bold" '),d.consistency&&null!=d.consistency[f?f:a-e]&&(c+=' c="'+d.consistency[f?
f:a-e]+'"'));return c}function ka(c,a,e){c[e][a]?c[e][a]++:c[e][a]=1}function Wa(c){for(var a,e,d=[],f=0;f<c[0].length;f++){d[f]={};for(var k=a=0;k<c.length;k++)e=c[k].charAt(f).toUpperCase(),e==da.gapChar?a++:(ka(d,e,f),"Q"!=e&&"E"!=e||ka(d,"QE",f),"E"==e||"D"==e?ka(d,"ED",f):-1<"/[WLVIMAFCYHP]/".indexOf(e)?ka(d,"WLVIMAFCYHP",f):"K"==e||"R"==e?ka(d,"KR",f):("T"==e||"S"==e)&&ka(d,"TS",f));d[f].gapCount=a;e={};for(var l in d[f])e[l+"_nogap"]=(d[f][l]/c.length).toFixed(2),d[f][l]=(d[f][l]/(c.length-
a)).toFixed(2);for(l in e)d[f][l]=e[l]}return d}function oa(c,a){var e=a.find("span").removeClass("hydrophobic polar small proline tiny aliphatic aromatic positive negative charged serThr large");if(0!=e.length){g.each(e,function(z,y){y.style.backgroundColor&&(y.style.backgroundColor="")});a.data("features")||(a.removeData("features"),a.data("currentColourScheme",c));null==c&&(c="rainbow");if(a.data("features")){var d="target-template"==a.data("templateData").type?"chain":"keyseqchain",f={};for(struc_id in a.data("features"))f.$jscomp$loop$prop$ft$17=
a.data("features")[struc_id],a.find("tr["+d+"][struc_id="+struc_id+"]").each(function(z){return function(){var y=g(this).attr(d);$span=g(this).find("span");for(var E=0;E<z.$jscomp$loop$prop$ft$17.length;E++)if(z.$jscomp$loop$prop$ft$17[E].frmChn!=z.$jscomp$loop$prop$ft$17[E].toChn)if(-1<z.$jscomp$loop$prop$ft$17[E].frmChn.indexOf(y)){var S="chain"==d?z.$jscomp$loop$prop$ft$17[E].resStart:z.$jscomp$loop$prop$ft$17[E].upStart;g.each($span.filter("[s="+S+"]"),function(ca,T){T.style.backgroundColor="rgba("+
z.$jscomp$loop$prop$ft$17[E].rgb+",.6)"})}else{if(-1<z.$jscomp$loop$prop$ft$17[E].toChn.indexOf(y)){var pa="chain"==d?z.$jscomp$loop$prop$ft$17[E].resEnd:z.$jscomp$loop$prop$ft$17[E].upEnd;g.each($span.filter("[s="+pa+"]"),function(ca,T){T.style.backgroundColor="rgba("+z.$jscomp$loop$prop$ft$17[E].rgb+",.6)"})}}else-1!=z.$jscomp$loop$prop$ft$17[E].frmChn.indexOf(y)&&(S="chain"==d?z.$jscomp$loop$prop$ft$17[E].resStart:z.$jscomp$loop$prop$ft$17[E].upStart,pa="chain"==d?z.$jscomp$loop$prop$ft$17[E].resEnd:
z.$jscomp$loop$prop$ft$17[E].upEnd,g.each($span.filter("[s]"),function(ca,T){T.getAttribute("s")>=S&&T.getAttribute("s")<=pa&&(T.style.backgroundColor="rgba("+z.$jscomp$loop$prop$ft$17[E].rgb+",.6)")}))}}(f)),f={$jscomp$loop$prop$ft$17:f.$jscomp$loop$prop$ft$17}}else if("chain"==c||"uniqueChain"==c||"template"==c){d=[];var k=null;if("undefined"!=typeof globalTemplateData){k=globalTemplateData;if(!globalTemplateData.chainColoursAssigned){for(var l=0;l<globalTemplateData.length;l++){var m=globalTemplateData[l];
...
Aa.indexOf(y.getAttribute("r"))&&g(y).addClass(c)});g.cookie("targetMismatch")&&"true"!=g.cookie("targetMismatch")||e.filter("[nm]").addClass("nonVisible");ha&&(N&&a.find("tr[seqno="+N.seqno+"]").find("span").eq(N.seqidx).addClass("cursor"),a.data("startEditRegion")&&a.data("endEditRegion")&&(e=a.data("startEditRegion"),f=a.data("endEditRegion"),l=e.closest("tr"),Y=l.attr("seqno"),l=l.siblings("[seqno="+Y+"]").addBack().find("span"),m=a.find("tr[seqno="+Y+"]").find("span"),m=m.slice(l.index(e),l.index(f)+
1).addClass("shadowCursor"),a.data("startEditRegion",m.first()),a.data("endEditRegion",m.last())))}}function Ka(c,a){if(c.data("templateData")){var e=c.data("templateData").templates;if(e){"undefined"===typeof currentWin&&(currentWin=window);for(var d={},f=0;f<e.length;d={$jscomp$loop$prop$identifier$6$25:d.$jscomp$loop$prop$identifier$6$25,$jscomp$loop$prop$assigned$24:d.$jscomp$loop$prop$assigned$24},f++)if(d.$jscomp$loop$prop$identifier$6$25=null,-1==a.indexOf("bfactor")&&"undefined"!=typeof SCORE_URL?
(d.$jscomp$loop$prop$identifier$6$25=e[f].pdb_id,d.$jscomp$loop$prop$identifier$6$25&&4!=d.$jscomp$loop$prop$identifier$6$25.length||(d.$jscomp$loop$prop$identifier$6$25=e[f].qname.match(/\w{4}\.\d+/)[0])):d.$jscomp$loop$prop$identifier$6$25=e[f].struc_id,d.$jscomp$loop$prop$identifier$6$25 in H||(H[d.$jscomp$loop$prop$identifier$6$25]={}),e[f].selected){if(!(a in H[d.$jscomp$loop$prop$identifier$6$25]))if(-1<a.indexOf("bfactor")){H[d.$jscomp$loop$prop$identifier$6$25].bfactor={};d.$jscomp$loop$prop$assigned$24=
!1;if(0<g("#pv:visible",currentWin.document).length)pv_viewer.forEach(function(t){return function(q){if(q.name()==t.$jscomp$loop$prop$identifier$6$25){for(var r={},v=0;v<q.structure().chains().length;r={$jscomp$loop$prop$cname$8$21:r.$jscomp$loop$prop$cname$8$21},v++){var w=q.structure().chains()[v];r.$jscomp$loop$prop$cname$8$21=w.name();"_"==r.$jscomp$loop$prop$cname$8$21||"-"==r.$jscomp$loop$prop$cname$8$21||-1<r.$jscomp$loop$prop$cname$8$21.indexOf("_res")||(H[t.$jscomp$loop$prop$identifier$6$25].bfactor[r.$jscomp$loop$prop$cname$8$21]=
{values:[],colours:[]},w.eachResidue(function(u){return function(A){for(var D=0,B=0;B<A._atoms.length;B++)D+=A._atoms[B].tempFactor();D/=A._atoms.length;H[t.$jscomp$loop$prop$identifier$6$25].bfactor[u.$jscomp$loop$prop$cname$8$21].values[A.num()-1]=D}}(r)))}t.$jscomp$loop$prop$assigned$24=!0}}}(d));else if(0<g("#ngl:visible",currentWin.document).length){var k=getNGLComponentByName(d.$jscomp$loop$prop$identifier$6$25);k&&k.structure.eachChain(function(t){return function(q){q.chainname.match(/(_|-)/)||
(H[t.$jscomp$loop$prop$identifier$6$25].bfactor[q.chainname]={values:[],colours:[]},q.eachResidue(function(r){var v=0;r.eachAtom(function(w){v+=w.bfactor});H[t.$jscomp$loop$prop$identifier$6$25].bfactor[q.chainname].values[r.resno-1]=v/r.atomCount}),t.$jscomp$loop$prop$assigned$24=!0)}}(d))}mn=1E10;mx=-1E10;count=rms=0;k=!0;for(cname in H[d.$jscomp$loop$prop$identifier$6$25].bfactor)for(var l=H[d.$jscomp$loop$prop$identifier$6$25].bfactor[cname],m=0;m<l.values.length;m++){var n=l.values[m];null!=
n&&(1<n&&(k=!1),mn=Math.min(n,mn),rms+=n*n,count++,l.colours[m]=10>=n?"0,0,255":10<n&&15>=n?"115,115,255":15<n&&20>=n?"170,170,255":20<n&&25>=n?"215,215,255":25<n&&30>=n?"255,215,215":30<n&&35>=n?"255,170,170":35<n&&40>=n?"255,115,115":"255,0,0")}if(d.$jscomp$loop$prop$assigned$24&&k){H[d.$jscomp$loop$prop$identifier$6$25].bfactor=null;H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range=null;continue}if("bfactor_range"==a){H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range={};k=[];for(l=0;256>
l;l++)k.push(l+","+l+",255");for(l=256;512>l;l++)k.push("255,"+(512-l)+","+(512-l));rms/=count;rms=Math.sqrt(rms);mx=2*rms;for(chn in H[d.$jscomp$loop$prop$identifier$6$25].bfactor)for(H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range[chn]={colours:[],values:[]},l=0;l<H[d.$jscomp$loop$prop$identifier$6$25].bfactor[chn].values.length;l++)(m=H[d.$jscomp$loop$prop$identifier$6$25].bfactor[chn].values[l])?(H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range[chn].values[l]=m,idx=Math.round(512*(m-
mn)/(mx-mn))-1,idx=Math.max(idx,0),idx=Math.min(idx,511),H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range[chn].colours[l]=k[idx]):H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range[chn].colours[l]=k[0]}if(!d.$jscomp$loop$prop$assigned$24){delete H[d.$jscomp$loop$prop$identifier$6$25].bfactor;delete H[d.$jscomp$loop$prop$identifier$6$25].bfactor_range;return}}else if("undefined"!=typeof SCORE_URL){H[d.$jscomp$loop$prop$identifier$6$25][a]=null;g.getJSON(SCORE_URL.replace("xxxx.0",d.$jscomp$loop$prop$identifier$6$25)+
a,function(t){return function(q,r){r&&(H[t.$jscomp$loop$prop$identifier$6$25][a]=q,g(".alignTbl").each(function(){Ka(g(this),a)}),qa())}}(d));return}if(null==H[d.$jscomp$loop$prop$identifier$6$25][a])return}c.find("tr[struc_id]").each(function(){var t=g(this).attr("chain");t||(t=g(this).attr("keyseqchain"));if(t){identifier=-1==a.indexOf("bfactor")?g(this).attr("qname").match(/\w+\.\d+/)[0]:g(this).attr("struc_id");if(null==H[identifier][a])return!0;if(null==H[identifier][a][t])for(var q in H[identifier][a])for(var r=
0;r<q.length;r++)q[r]==t&&(H[identifier][a][q[r]]=H[identifier][a][q]);if(H[identifier]&&H[identifier][a]&&H[identifier][a][t]){var v=null;g(this).find("span[s]").each(function(w,u){v=u.getAttribute("s");null!=H[identifier][a][t].values[v-1]&&(u.title=R[g(this).text()].triplet+" : "+v+"; "+a+" : "+H[identifier][a][t].values[v-1].toFixed(2));u.style.backgroundColor="rgba("+H[identifier][a][t].colours[v-1]+",.6)"})}}})}}}function qa(c){0<g("#pv:visible",currentWin.document).length&&cb();0<g("#ngl:visible",
currentWin.document).length&&(c&&c.singleResidue?db(c.singleResidue):eb(c));if(!("function"!==typeof colourUPArcs&&"function"!==typeof colourRama||c&&c.singleResidue)){var a={};g(".alignTbl").each(function(){$alignTbl=g(this);var e=$alignTbl.data("templateData");if(e&&!$alignTbl.data("options").textOnly){var d=-1,f=null;"model-template"==e.type?$rows=$alignTbl.find("tr[keyseqchain]"):($rows=$alignTbl.find("tr[chain]"),f=$alignTbl.find("tr[seqno=1]").find("span"));for(;;){d++;e=$rows.filter("[seqno="+
d+"]");if(1>e.length)if(1<d)break;else continue;var k=e.attr("chain");k||(k=e.attr("keyseqchain"));var l=e.attr("struc_id"),m=[];a[l]||(a[l]={});a[l][k]||(a[l][k]=m,e.find("span").each(function(n,t){var q=g(t).css("background-color");q&&"transparent"!=q&&-1==q.indexOf("(0, 0, 0")&&(q=q.match(/\d+, \d+, \d+/)[0].split(","),m[f?f[n].getAttribute("s"):t.getAttribute("s")]=q)}))}}});"function"===typeof colourRama&&colourRama(a);"function"===typeof colourUPArcs&&colourUPArcs(a)}}function db(c){for(schemeId in NGL.ColormakerRegistry.userSchemes)-1<
schemeId.indexOf("singleres")&&(NGL.ColormakerRegistry.removeScheme(schemeId),ngl_stage.eachRepresentation(function(e){if(e.repr.colorScheme==schemeId)for(schemeId2 in NGL.ColormakerRegistry.userSchemes)if(schemeId2.endsWith(e.name)){e.setColor(schemeId2);break}}));if(c){var a=c.struc_id;getNGLComponentByName(a)&&ngl_stage.eachRepresentation(function(e){if(e.name==a&&U[a]){var d=U[a],f=NGL.ColormakerRegistry.addScheme(function(k){for(chn in d)" "==chn&&g("#ngl_status").html("NGL cannot colour or select chains named whitespace!");
this.atomColor=function(l){return d[l.chainname]?ngl_picked_atom&&l.structure.name==ngl_picked_atom.structure.name&&l.index==ngl_picked_atom.index?16711680:(l=d[l.chainname][l.resno])?l[0]<<16|l[1]<<8|l[2]:16777215:16777215}},"singleres");e.setColor(f)}})}}function eb(c){var a=null,e;U={};g(".alignTbl:not(.ignoreStructure)").each(function(){e=g(this);var k=e.data("templateData");if(k&&!e.data("options").textOnly){var l=-1;for(a="model-template"==k.type?e.find("tr[keyseqchain]"):e.find("tr[chain]");;){l++;
var m=a.filter("[seqno="+l+"]");if(1>m.length)if(1<l)break;else continue;(k=m.attr("chain"))||(k=m.attr("keyseqchain"));var n=m.attr("struc_id");m=m.find("span");var t=null;t=U[n]&&U[n][k]?U[n][k]:[];m.each(function(q,r){var v=g(r).css("background-color");v&&"transparent"!=v&&-1==v.indexOf("(0, 0, 0")&&(v=v.match(/\d+, \d+, \d+/)[0].split(","),t[r.getAttribute("s")]=v)});U[n]||(U[n]={});U[n][k]=t}}});c=c&&c.strucId?c.strucId:null;for(var d in ngl_stage.compList)if(void 0!==ngl_stage.compList[d].structure){var f=
ngl_stage.compList[d].name;if(!c||f==c){for(schemeId in NGL.ColormakerRegistry.userSchemes)-1<schemeId.indexOf(f)&&-1==schemeId.indexOf("membrane")&&NGL.ColormakerRegistry.removeScheme(schemeId);ngl_stage.eachRepresentation(function(k){if((k.name==f||k.name.endsWith(".highlight"))&&U[f]){var l=U[f],m=NGL.ColormakerRegistry.addScheme(function(n){for(chn in l)" "==chn&&g("#ngl_status").html("NGL cannot colour or select chains named whitespace!");this.atomColor=function(t){return l[t.chainname]?(t=l[t.chainname][t.resno])?
t[0]<<16|t[1]<<8|t[2]:16777215:16777215}},f);k.setColor(m)}})}}}function cb(){if(0!=pv_viewer.all().length){var c=null,a,e={};g(".alignTbl:not(.ignoreStructure)").each(function(){a=g(this);var k=a.data("templateData");if(k&&!a.data("options").textOnly){var l=-1;for(c="model-template"==k.type?a.find("tr[keyseqchain]"):a.find("tr[chain]");;){l++;var m=c.filter("[seqno="+l+"]");if(1>m.length)if(1<l)break;else continue;(k=m.attr("chain"))||(k=m.attr("keyseqchain"));var n=m.attr("struc_id");m=m.find("span");
var t=null;t=e[n]&&e[n][k]?e[n][k]:[];m.each(function(q,r){var v=g(r).css("background-color");v&&"transparent"!=v&&-1==v.indexOf("(0, 0, 0")&&(v=v.match(/\d+, \d+, \d+/)[0].split(","),t[r.getAttribute("s")]=v)});e[n]||(e[n]={});e[n][k]=t}}});for(var d in e){var f=e[d];pv_viewer.get(d)&&pv_viewer.get(d).colorBy(new pv.color.ColorOp(function(k,l,m){k=k.residue();f[k.chain().name()]&&((k=f[k.chain().name()][k.num()])?(l[m]=k[0]/255,l[m+1]=k[1]/255,l[m+2]=k[2]/255):(l[m]=.9,l[m+1]=.9,l[m+2]=.9),l[m+3]=
1)}))}d&&pv_viewer.requestRedraw()}}function ia(c){var a=g.cookie("secStruct");null==a&&(a="dssp");var e=c.attr("id")+"_features";g("#"+e).html("");if(0==g("#"+e).length||a&&"none"==a)c.removeClass("ss"),G(c).removeClass("ss");else{c.addClass("ss");G(c).addClass("ss");var d=c.position().top,f=c.find("td").first().width(),k=c.find("span")[0],l=k.getBoundingClientRect().width;k=k.getBoundingClientRect().height;var m=c.position().left;if(!(1>f)){p=Raphael(e,f,c.height());g("#"+e).css("top",c.position().top);
var n=c.data("templateData");if(n){c=c.find("tr:visible");if(n.keyseq_annotation)for(e=0;e<n.keyseq_chain_name.length;e++){var t=n.keyseq_chain_name[e];if(n.keyseq_annotation[t]){var q=n.templates[0].trg_offset?n.templates[0].trg_offset:1;n.keyseq_annotation[t][a]&&Qa(p,Ra(n.keyseq_annotation[t],a,q),c.filter('[keyseqchain="'+t+'"]'),c.filter('[keyseqchain="'+t+'"]').find("span[s]").toArray(),d,m,f,l,k);n.charts&&function(A,D,B){setTimeout(function(){fb(A,n.keyseq_annotation[D],a,q,B,d,f,l,5E3>n.pageResidueCount)},
0)}(p,t,c.filter('[keyseqchain="'+t+'"]'))}}e=0;for(t=1;t<c.length;t++){var r=c.eq(t);if(parseInt(r.attr("seqno"))<e)break;e=parseInt(r.attr("seqno"));if(!r.attr("keyseqtype")){var v=r.attr("tpl_id");r=r.attr("chain");$row=v?c.filter('[tpl_id="'+v+'"]'):c.filter('[chain="'+r+'"]');for(var w=$row.find("span[s]").toArray(),u=0;u<n.templates.length;u++)(v?n.templates[u].id==v:n.templates[u].chain==r)&&n.templates[u].annotation&&n.templates[u].annotation[a]&&Qa(p,Ra(n.templates[u].annotation,a),$row,
w,d,m,f,l,k)}}}}}}function Oa(c,a){var e=c[a];"string"==typeof e&&(c[a+"_string"]=e.replace(/[GI]/g,"H").replace(/B/g,"E"));return c[a+"_string"]}function Ra(c,a,e){e||(e=1);var d=c[a];if("string"==typeof d){c[a+"_string"]=c[a];d=c[a].replace(/[GI]/g,"H").replace(/B/g,"E");for(var f=null,k=0;k<d.length;k++)if("H"==d[k]||"E"==d[k])res_index=k+e,null==f?f=[[res_index,res_index,d[k]]]:f[f.length-1][1]==res_index-1&&f[f.length-1][2]==d[k]?f[f.length-1][1]=res_index:f.push([res_index,res_index,d[k]]);
c[a]=f}return c[a]}function fb(c,a,e,d,f,k,l,m,n){var t=null!=a.qmean;d||(d=1);var q=c.set(),r=c.set(),v=c.set();f.each(function(w,u){span=g(u).find("span").toArray();if(0!=span.length){var A=ea-W,D=g(u).position().top-k+g(span[0]).position().top-W,B=D,C=u.getBoundingClientRect().left,F=span[span.length-1].getBoundingClientRect().right-C;if(t){c.path("M0,"+B+"L"+l+","+B+"L"+l+","+(B-A)+"L0,"+(B-A)).attr({"stroke-width":.4,stroke:"#888"});for(var K=3;10>K;K++){var M=B-1/.7*A*(K/10-.3);var I=c.path("M0,"+
M+"L"+l+","+M);5==K?I.attr({"stroke-width":.7,opacity:.8,stroke:"#888","stroke-dasharray":"-"}):q.push(I)}}I="";var O;for(K=0;K<span.length;K++)if(M=span[K],M.hasAttribute("s")){if(B=parseInt(M.getAttribute("s"))-d,I=a[e+"_string"]&&a[e+"_string"][B]?I+a[e+"_string"][B]:I+"-",x=M.getBoundingClientRect().left-C,B=D,B-=2,t){var X=Math.max(.3,parseFloat(M.getAttribute("q")));M=B-1/.7*(A-2)*(X-.3);if(n){var J="245,80,0";.5<X&&(w=Math.round(490*(1-X)),b=Math.round(255*X),J=w+",80,"+b);s=c.path("M"+x+","+
B+"L"+x+","+M+"L"+(x+m)+","+M+"L"+(x+m)+","+B);s.attr({fill:"rgba("+J+",.6)",stroke:"#333"})}else O+="M"+x+" "+B,O+="L"+x+" "+M,O+="L"+(x+m)+" "+M,O+="L"+(x+m)+" "+B}}else I+="-";txt=c.text(2,D+W/2,I);r.push(txt);txt.node.setAttribute("textLength",F-4+"px");txt.node.firstChild.setAttribute("textLength",F-4+"px");v.push(c.path(O))}});r.attr({"text-anchor":"start","font-family":"consolas"});v.attr({stroke:"#555"});q.attr({"stroke-width":.9,stroke:"#888",opacity:.6,"stroke-dasharray":". "})}function Qa(c,
a,e,d,f,k,l,m,n){if(null!=a){e.attr("seqno");for(var t=0,q=d.length,r=0;r<a.length;r++)if("E"==a[r][2]||"H"==a[r][2]){var v=null,w=null,u;for(u=a[r][0];u<=a[r][1];u++)if(!(d[t].getAttribute("s")>u)){for(s=t;s<q;s++)if(d[s].getAttribute("s")==u){t=s;v=g(d[s]);break}if(v)break}for(u=a[r][1];u>=a[r][0];u--){for(s=t;s<q;s++)if(d[s].getAttribute("s")==u){t=s;w=g(d[s]);break}if(w)break}if(null==v||null==w)t=0;else for(thisRow=v.closest("tr"),startRowIdx=e.index(thisRow),endRowIdx=e.index(w.closest("tr")),
v=v.position(),startResLeft=v.left-k,spanTop=v.top,endResLeft=w.position().left-k,rightLimit=thisRow.width()-m-m,w=startRowIdx;w<endRowIdx+1;w++)if(w>startRowIdx&&(thisRow=e.eq(w),spanTop=thisRow.find("span").first().position().top),u=thisRow.position().top+spanTop-f,"E"==a[r][2]){v=c;var A=startResLeft-(w-startRowIdx)*l,D=endResLeft+(endRowIdx-w)*l,B=m,C=n,F=rightLimit;u+=1;C-=2;padding=2;A=Math.max(-B,Math.round(A));D=Math.min(F,Math.round(D+B));s=v.path("M"+A+","+(u-padding)+"L"+(D-6)+","+(1.5+
u)+"L"+(D-6)+","+(u-padding)+"L"+(D+padding)+","+(C/2+u)+"L"+(D-6)+","+(C+u+padding)+"L"+(D-6)+","+(C-1.5+u)+"L"+A+","+(C+u+padding)+"L"+A+","+(u-padding));s.attr({"stroke-width":.7,fill:"#DDD","fill-opacity":.3,stroke:"#226","stroke-dasharray":"5 2"})}else v=c,A=startResLeft-(w-startRowIdx)*l,D=endResLeft+(endRowIdx-w)*l,B=m,C=n,F=rightLimit,padding=2,A=Math.max(-B,Math.round(A)),D=Math.min(F,Math.round(D+B)),h=v.rect(A,u+2-padding,D-A,C-4+2*padding,4),h.attr({"stroke-width":.7,fill:"#DDD","fill-opacity":.3,
stroke:"#226"})}}}function Sa(){var c="";"Multi FASTA"==g("#alignmentFormatSelect").val()?g(".alignTbl:visible").each(function(){c+=Ba(g(this).attr("id").substring(8),"FASTA");c+="\n"}):c=Ba(g("#currentAlignmentIndex").val(),g("#alignmentFormatSelect").val());g("#formattedAlignmentTextarea").val(c);g("#formattedAlignmentTextarea").focus();g("#formattedAlignmentTextarea").select()}function Ba(c,a){a||(a="fasta");var e=g("#alignNameTbl"+c),d=g("#alignTbl"+c),f=[],k=[],l=[],m=0<g("#alignTbl"+c+" :visible").first().length?
":visible":"",n=0;e.find("tr[seqno]"+m).each(function(t,q){parseInt(q.getAttribute("seqno"))>n&&n++}).slice(0,n).each(function(t){var q=g(this).attr("seqno");f[t]=g(this).text();l[t]=g(this).attr("title");breakCount=0;d.find('tr[seqno="'+q+'"]').each(function(r){k[t]||(k[t]="");k[t]+=g(this).find("td").first().text();breakCount+=g(this).find(".insert_l,.insert_r").length});0<breakCount&&(f[t]="MULTIPLE_SEGMENTS_OF_"+f[t]+" - WARNING - CONTAINS NON-SEQUENTIAL SEGMENTS")});return-1<a.search(/fasta/i)?
gb(f,k,l):-1<a.search(/clustal/i)?hb(f,k):""}function gb(c,a,e){if(!a||0==a.length)return"No templates selected";for(var d="",f=0;f<c.length;f++){d+=">"+c[f]+(e&&e[f]?" "+e[f]:"")+"\n";for(var k=0;k<a[f].length;k+=72)d+=a[f].substring(k,k+72)+"\n"}return d}function hb(c,a){if(!a||0==a.length)return"No templates selected";for(var e=0,d=0;d<c.length;d++)e=Math.max(e,c[d].length);e+=2;for(var f="CLUSTAL\n\n",k=0;k<a[0].length;k+=60){for(d=0;d<c.length;d++){f+=c[d];for(var l=c[d].length;l<e;l++)f+=" ";
f+=a[d].substring(k,k+60)+"\n"}f+="\n"}return f=f.substring(0,f.length-2)}function ib(c){$alignNameTbl=G(c);var a=c.closest(".alignTblContainer").outerWidth(),e=c.closest(".alignTblContainer").outerHeight();a+=10;var d='<svg xmlns="http://www.w3.org/2000/svg"  width="'+a+'" height="'+e+'"><rect x="0" y="0" fill="white" width="'+a+'" height="'+e+'"/>',f,k=$alignNameTbl.outerWidth()+10,l=$alignNameTbl.offset().left-10,m=c.find("td:eq(0)");a=m.outerWidth();var n=g("<div>").append(g("#"+c.attr("id")+
"_features svg").first().clone()).html().replace(/name="[\d_]+" /g,"").replace(/r="4" /g,"");d+='<defs><clipPath id="cp2"><rect x="0" y="0" width="'+a+'" height="'+e+'"/></clipPath></defs>';d+='<g transform="translate('+k+',0)" clip-path="url(#cp2)">';d+=n.substring(n.indexOf("</defs>")+7,n.indexOf("</svg>"));d+="</g>";e=c.find("tr:visible");e.each(function(r,v){g(this).find("span.ligandContact").each(function(w,u){f=v.offsetTop+u.offsetTop;t||(t=g(u).outerWidth(),q=g(u).outerHeight());g(u).css("color");
d+='<rect style="fill:#CC4444;fill-opacity:0.8;" width="'+t+'" height="'+q+'" x="'+(g(u).offset().left-l)+'" y="'+f+'" />'})});d+='<text text-anchor="end" font-size="'+m.css("font-size")+"\" font-family='"+m.css("font-family")+"'>";e=$alignNameTbl.find("tr:visible");e.each(function(r,v){var w=g(this).find("td").css("padding-top");w=parseInt(w.substring(0,w.length-2));f=v.offsetTop+12+w;d+='<tspan x="'+(k-2)+'" y="'+f+'">'+v.textContent.replace("QMEAN","")+"</tspan>"});d+="</text>";e=c.find("tr:visible");
var t,q;e.offset();e.each(function(r,v){d+='<text text-anchor="middle" font-size="'+m.css("font-size")+"\" font-family='"+m.css("font-family")+"'>";g(this).find("span").each(function(w,u){t||(t=g(u).outerWidth(),q=g(u).outerHeight());if("relative"!=u.style.position){var A=g(u).css("color");A="fill:"+A+";";"bold"==u.style.fontWeight&&(A+="font-weight:bold;");0<A.length&&(A=' style="'+A+'" ');f=v.offsetTop+u.offsetTop+12;d+='<tspan x="'+(g(u).offset().left-l+t/2)+'" y="'+f+'"'+A+">"+u.textContent+"</tspan>"}});
d+="</text>";(td=g(this).find("td")[1])&&(d+='<text text-anchor="start" font-size="'+m.css("font-size")+"\" font-family='"+m.css("font-family")+"'><tspan x=\""+(g(td).offset().left-l+10)+'" y="'+f+'">'+td.textContent+"</tspan></text>")});e.each(function(r,v){g(this).find("span").not(".ligandContact").each(function(w,u){f=v.offsetTop+u.offsetTop;var A=g(u).css("backgroundColor");A&&"transparent"!=A&&"rgb(255, 255, 255)"!=A&&(d+='<rect x="'+(g(u).offset().left-l)+'" y="'+f+'" width="'+t+'" height="'+
q+'" style="fill:'+A+';"/>')})});return d+"</svg>"}var H={},da={gapChar:"-"},Ta=!1,ha=!1,N=null,ea=0,W=0,ra=!1,va=null,V=0,fa=0,P="rgba(136,221,204,.6) rgba(213,178,64,.6) rgba(187,187,221,.6) rgba(255,136,119,.6) rgba(136,187,221,.6) rgba(255,187,102,.6) rgba(187,221,102,.6) rgba(255,204,238,.6) rgba(166,206,227,.6) rgba(187,136,187,.6) rgba(204,238,204,.6) rgba(166,206,227,.6)".split(" "),na={init:function(c){Ta||(Ta=!0,g(document).keydown(function(a){if(ha&&1>g(".fancybox-desktop:visible").length)a:if(ra)a.preventDefault();
else{var e=g("span.cursor").closest(".alignTbl");if(32==a.keyCode)a.preventDefault(),Da();else if(8==a.keyCode||46==a.keyCode)a.preventDefault(),Ca(8==a.keyCode);else if(27==a.keyCode){e.data("startEditRegion",null);e.data("endEditRegion",null);g(".shadowCursor").removeClass("shadowCursor");break a}else if((a.ctrlKey||a.metaKey)&&90==a.keyCode){a=g("body").data("editHistory");if(!(null==a||1>a.length)){a=a.pop();wa(e,a,!0,!0);var d=g(".alignTbl").not(e);0<d.length&&(wa(d,a,!0,!1),g(".cursor").removeClass("cursor"),
e.find("tr[seqno="+N.seqno+"]").find("span").eq(N.seqidx).addClass("cursor"))}break a}xa(null,a)}else 27==a.keyCode&&(g(".hoverResidue").removeClass("hoverResidue"),g(".selectResidue").removeClass("selectResidue"))}));return this.each(function(){var a=g.extend({},{type:"target-template",chaingroups:[],keyseq_sequence:c.keyseq_sequence,keyseq_chain_name:c.keyseq_chain_name?c.keyseq_chain_name:["A"],keyseq_annotation:c.keyseq_annotation},c.templateData);c.nowrap&&(a.nowrap=!0);if(c.charts&&c.keyseq_annotation){a.qmLength=
0;a.charts=c.charts;for(key in c.keyseq_annotation)break;c.keyseq_annotation[key].qmean&&(a.pageResidueCount=c.pageResidueCount,ea=48);W=12}c.resetColourCycle&&(V=0);c.firstDraw=!0;g(this).data("templateData",a);ba(g(this),null,c);na.toggleIdenticalSeqs.call(this,{chaingroups:a.chaingroups},!1);na.resizeToParent.call(g(this),{redrawAnnotation:!1});ia(g(this));Q(g(this));va=g(".alignmentOptions input[name=csRadioGroup]:checked").val()})},toggleIdenticalSeqs:function(c,a){return g(this).each(function(){for(var e=
g(this),d=G(e),f=0;f<c.chaingroups.length;f++){var k=c.chaingroups[f].filter(function(){return!0});if(!(2>k.length)){var l=k[0],m=d.find('tr[chain="'+l+'"]').first().text(),n=m.substring(0,m.lastIndexOf(".")+1)+"("+k.join("")+")";m=m.substring(0,m.lastIndexOf("."))+"."+l.charAt(0);for(var t="",q=1;q<k.length;q++)t+="[chain="+k[q]+"]",q<k.length-1&&(t+=",");e.find("tr"+t).toggle();d.find("tr"+t).toggle();"none"==d.find("tr[chain="+k[1]+"]").css("display")?d.find("tr[chain="+l+"]").find("td").html(n):
d.find("tr[chain="+l+"]").find("td").html(m)}}("undefined"==typeof a||a)&&ia(e)})},drawAlignment:function(c){return this.each(function(){ba(g(this),c?c.seqs:null,c?c:null);Q(g(this))})},getFormattedAlignment:function(c){return Ba(g(this).attr("id").substring(8),c.format)},exportAlignment:function(c){return this.each(function(){g("#formattedAlignment").show();g("#alignmentFormatSelect").val(c.format);Sa();g("<a href='#formattedAlignment' title='Copy & Paste Alignment'/>'").fancybox({helpers:{title:{type:"inside"}}}).trigger("click");
g("#formattedAlignmentTextarea").focus();g("#formattedAlignmentTextarea").select()})},html2image:function(c){g.fancybox.close();g(".popover").hide();c=g("#currentAlignmentIndex").val();$alTbl=g("#alignTbl"+c);c=ib($alTbl);c=new Blob([c],{type:"image/svg+xml;charset=utf-8"});c=(window.URL||window.webkitURL||window).createObjectURL(c);var a=new Image,e=document.createElement("canvas"),d=e.getContext("2d");a.onload=function(){e.width=this.naturalWidth;e.height=this.naturalHeight;d.drawImage(this,0,0);
e.toBlob(function(f){saveAs(f,"alignment.png")},"image/png")};a.src=c},getSelectedColourScheme:function(){return va},setSelectedColourScheme:function(c){va=c},colourAlignment:function(c){"undefined"===typeof currentWin&&(currentWin=window);if(c.features)$alignTbls=c.alignTbls?c.alignTbls:g(".alignTbl"),$alignTbls.each(function(){var e=!1;for(struc_id in c.features)if(0<g(this).find("tr[struc_id="+struc_id+"]").length){e=!0;break}e&&(g(this).data("features",c.features),oa("features",g(this)))});else{jQuery.cookie("colourScheme",
c.col,{expires:365,path:"/"});c.col||(c.col=va);var a=g(".alignTbl").each(function(){g(this).removeData("features");null!=g(this).data().options&&delete g(this).data().options.default_colour;oa(c.col,g(this))})}qa();return a},changeExportFormat:function(c){return this.each(function(){Sa()})},secondaryStructure:function(c){c&&jQuery.cookie("secStruct",c.sstype,{expires:365,path:"/"});var a=null;a=c?c.sstype:g.cookie("secStruct");null==a&&(a="dssp");W="none"==a?0:12;c=this.each(function(){g(this).data("templateData")&&
(ia(g(this)),"secstruc"==g(this).data("currentColourScheme")&&oa("secstruc",g(this)))});var e=null,d=null;e=null;"undefined"!=typeof globalTemplateData?(g("#alignTbl"),"undefined"!=typeof globalTemplateData&&(d=globalTemplateData)):g(this).data("templateData")&&("model-template"==g(this).data("templateData").type?e=!0:(d=[],this.each(function(){g(this).data("templateData")&&(d=d.concat(g(this).data("templateData").templates))})));if(0<g("#pv:visible",currentWin.document).length)if(e)this.each(function(){var q=
g(this).data("templateData");if(q){var r=q.struc_id;if(pv_viewer.get(r)){var v=pv_viewer.get(r).structure();pv_viewer.rm(r);var w="none"==a;if(!w)for(var u=0;u<q.keyseq_chain_name.length;u++){var A=q.keyseq_chain_name[u],D=q.templates[0].trg_offset;D||(D=1);var B=q.keyseq_annotation[A][a+"_string"];A=v.select({chain:A});B?A.eachResidue(function(C){C.full().setSS(B[C.num()-D])}):w=!0}w&&v.select("protein").eachResidue(function(C){C.full().setSS("")});pv_viewer.cartoon(r,v,{color:pv.color.uniform("white")})}}});
else for(var f=0;f<d.length;f++){if(d[f].selected){var k=d[f].struc_id;e=pv_viewer.get(k).structure();pv_viewer.rm(k);if("none"==a)e.select("protein").eachResidue(function(q){q.full().setSS("")});else if(d[f].targets)for(var l=0;l<d[f].targets.length;l++)for(var m=d[f].targets[l],n=0;n<m.chain.length;n++)(t=m.annotation[m.chain[n]][a+"_string"])||(t=m.annotation[m.chain[n]][a]),e.select({chain:m.chain[n]}).eachResidue(function(q){q.full().setSS(t[q.num()-1])});else{var t=d[f].annotation[a+"_string"];
t||(t=d[f].annotation[a]);e.select({chain:d[f].chain}).eachResidue(function(q){q.full().setSS(t?t[q.num()-1]:"")})}pv_viewer.cartoon(k,e,{color:pv.color.uniform("white")})}}else if(0<g("#ngl:visible",currentWin.document).length)if(e)this.each(function(){var q=g(this).data("templateData");if(q)for(var r=q.struc_id,v="none"==a,w=0;w<q.keyseq_chain_name.length;w++){var u=q.keyseq_chain_name[w],A=q.templates[0].trg_offset;A||(A=1);var D=q.keyseq_annotation[u][a+"_string"];D||(v=!0);for(comp in ngl_stage.compList)if(ngl_stage.compList[comp].name==
r){ngl_stage.compList[comp].structure.eachResidue(function(B){B.chainname==u&&(B.sstruc=v?"":D[B.resno-A].toLowerCase())});break}}});else for(f=0;f<d.length;f++)if(d[f].selected){ngl_stage.eachRepresentation(function(q){if(q.name&&!q.name.match(/(ligands|dna|over)/)){var r=q.name;for(comp in ngl_stage.compList)ngl_stage.compList[comp].name==r&&ngl_stage.compList[comp].removeRepresentation(q)}});if("none"==a)for(comp in ngl_stage.compList)ngl_stage.compList[comp].name==d[f].struc_id&&ngl_stage.compList[comp].structure.eachResidue(function(q){q.sstruc=
""});else if(d[f].targets)for(l=0;l<d[f].targets.length;l++)for(m=d[f].targets[l],n=0;n<m.chain.length;n++)for(comp in(t=m.annotation[m.chain[n]][a+"_string"])||(t=m.annotation[m.chain[n]][a]),ngl_stage.compList){if(ngl_stage.compList[comp].name==d[f].struc_id){ngl_stage.compList[comp].structure.eachResidue(function(q){q.chainname==m.chain[n]&&(q.sstruc=t[q.resno-1].toLowerCase())});break}}else for(comp in t=d[f].annotation[a+"_string"]?d[f].annotation[a+"_string"]:d[f].annotation[a],ngl_stage.compList)if(ngl_stage.compList[comp].name==
d[f].struc_id){ngl_stage.compList[comp].structure.eachResidue(function(q){q.chainname==d[f].chain&&(q.sstruc=t?t[q.resno-1].toLowerCase():"")});break}k=d[f].struc_id;for(comp in ngl_stage.compList)ngl_stage.compList[comp].name==k&&ngl_stage.compList[comp].addRepresentation("cartoon",{name:k,sele:"not :_ and not nucleic and not :-",smoothSheet:!0,aspectRatio:6,roughness:1})}changeRep(g.cookie("defaultRepr"));qa();return c},targetMismatch:function(c){jQuery.cookie("targetMismatch",c.match,{expires:365,
path:"/"});return this.each(function(){c.match?g(this).find("span[nm]").addClass("nonVisible"):g(this).find("span[nm]").removeClass("nonVisible")})},viewerInitialised:function(c){g.cookie("colourScheme")&&0==g.cookie("colourScheme").indexOf("bfactor")&&"undefined"===typeof defaultColour?g(".alignTbl").alignment("colourAlignment",{col:g.cookie("colourScheme")}):qa(c);0<g("#pv:visible",currentWin.document).length&&pv_viewer.fitParent()},updateColoursSingleResidue:function(c){qa({singleResidue:c})},
resizeToParent:function(c,a){a=c?c.redrawAnnotation:!0;return this.each(function(){var e=g(this);if(e.is(":visible")&&e.data("templateData")){var d=g(this).find("tr:visible td").first(),f=d.find("span").first()[0],k=e.width()-d.width(),l=e.parent().closest("table").parent();l=l.width()-(e.offset().left-l.offset().left)-k;e.data("templateData").nowrap&&(l=1E7);k=d.text().length;f=Math.floor(l/f.getBoundingClientRect().width);e.data("options").textOnly&&(f=Math.floor(l/(d.width()/d.text().length)));
f-=f%5;1>f&&(f=5);d=0<e.find("tr:hidden").length;l=e.data("templateData").chaingroups;f>k&&1<e.find("tr[keyseqchain]").length||f<k?(e.attr("cols_cookie")&&g.cookie(e.attr("cols_cookie"),f,{expires:365,path:"/"}),ba(e,null,{cols:f}),a&&ia(e),d&&na.toggleIdenticalSeqs.call(e,{chaingroups:l})):(a&&ia(e),g("#"+e.attr("id")+"_features").css("top",e.position().top))}})},toggleEditMode:function(c){g(this).attr("id").substring("8");(ha=c&&null!=c.edit?c.edit:!ha)?(g("a[id^=gapEdit_]").css("opacity",1),g(".hoverResidue").removeClass("hoverResidue"),
null==N&&(N={seqno:1,seqidx:0}),g(this).find("tr[seqno="+N.seqno+"]").find("span").eq(N.seqidx).addClass("cursor")):(g("a[id^=gapEdit_]").css("opacity",.6),g(".cursor").removeClass("cursor"))},removeGappedColumns:function(c){c=g(this).data("templateData").templates;var a=c[0].trg_seq;for(var e=c[0].tpl_seq,d="",f="",k=0;k<a.length;k++)if("-"!=a.charAt(k)||"-"!=e.charAt(k))d+=a.charAt(k),f+=e.charAt(k);a=[d,f];c[0].trg_seq=a[0];c[0].tpl_seq=a[1];ba(g(this))}},Ha={},ab="rgba(238,51,17,.5)",Ma="rgba(17,119,238,.5)",
ua="rgba(17,204,17,.5)",Ya="rgba(255,102,0,.5)",Za="rgba(17,187,187,.5)",$a="rgba(238,119,119,.5)",La="rgba(204,68,204,.5)",Xa="rgba(204,204,0,.5)",R={A:{name:"Alanine",triplet:"ALA",hydropathy:.7,mw:.11},C:{name:"Cysteine",triplet:"CYS",hydropathy:.78,mw:.35},D:{name:"Aspartate",triplet:"ASP",hydropathy:.11,mw:.45},E:{name:"Glutamate",triplet:"GLU",hydropathy:.11,mw:.56},F:{name:"Phenylalanine",triplet:"PHE",hydropathy:.81,mw:.7},G:{name:"Glycine",triplet:"GLY",hydropathy:.46,mw:0},H:{name:"Histidine",
triplet:"HIS",hydropathy:.14,mw:.62},I:{name:"Isoleucine",triplet:"ILE",hydropathy:1,mw:.43},K:{name:"Lysine",triplet:"LYS",hydropathy:.07,mw:.55},L:{name:"Leucine",triplet:"LEU",hydropathy:.92,mw:.43},M:{name:"Methionine",triplet:"MET",hydropathy:.71,mw:.57},N:{name:"Asparagine",triplet:"ASN",hydropathy:.11,mw:.44},P:{name:"Proline",triplet:"PRO",hydropathy:.32,mw:.31},Q:{name:"Glutamine",triplet:"GLN",hydropathy:.11,mw:.55},R:{name:"Arginine",triplet:"ARG",hydropathy:0,mw:.77},S:{name:"Serine",
triplet:"SER",hydropathy:.41,mw:.23},T:{name:"Threonine",triplet:"THR",hydropathy:.42,mw:.34},V:{name:"Valine",triplet:"VAL",hydropathy:.97,mw:.32},W:{name:"Tryptophan",triplet:"TRP",hydropathy:.4,mw:1},Y:{name:"Tyrosine",triplet:"TYR",hydropathy:.36,mw:.82},B:{name:"Aspartate or Asparagine",triplet:"ASX"},Z:{name:"Glutamate or Glutamine",triplet:"GLX"},J:{name:"Leucine or Isoleucine",triplet:"XLE"},X:{name:"Unknown",triplet:"UNC"},"?":{name:"Unknown",triplet:"UNC"},hydrophobic:"LIFWVM",polar:"RKDENQ",
small:"TDN",large:"WYRFH",aliphatic:"ILV",charged:"HKRED",positive:"HKR",negative:"ED",tiny:"AGS",aromatic:"FYWH",proline:"P",serThr:"ST"},U=null;g.fn.alignment=function(c){if(na[c])return na[c].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof c&&c)g.error("Method "+c+" does not exist on alignment.min.js");else return na.init.apply(this,arguments)}})(jQuery);Object.keys||(Object.keys=function(g){var G=[],Q;for(Q in g)g.hasOwnProperty(Q)&&G.push(Q);return G});
$(document).on("click",".alignmentOptions input[name=csRadioGroup]",function(){var g=$(this).val();$(".alignTbl").alignment("colourAlignment",{col:g});$(".alignTbl").alignment("setSelectedColourScheme",g)});$(document).on("click","#viewerSelect input[name=3dRG]",function(){showViewer($(this).val())});
